...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), 'C:/Program Files/EasyPHP-12.1/www/ProjetWebSujet2-master/app/cache/dev/annotations', true);
    }
    ...
    {
        $this->services['assetic.asset_manager'] = $instance = new \Assetic\Factory\LazyAssetManager($this->get('assetic.asset_factory'), array('twig' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \Assetic\Extension\Twig\TwigFormulaLoader($this->get('twig')), new \Assetic\Cache\ConfigCache('C:/Program Files/EasyPHP-12.1/www/ProjetWebSujet2-master/app/cache/dev/assetic/config'), true)));
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->setNamespace('sf2orm_default_308c26210cd3ec52c02bc99aa31ff07c');

        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_308c26210cd3ec52c02bc99aa31ff07c');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_308c26210cd3ec52c02bc99aa31ff07c');

        $d = new \Doctrine\ORM\Mapping\Driver\SimplifiedYamlDriver(array('C:\\Program Files\\EasyPHP-12.1\\www\\ProjetWebSujet2-master\\src\\Acme\\SecurityBundle\\Resources\\config\\doctrine' => 'Acme\\SecurityBundle\\Entity'));
        $d->setGlobalBasename('mapping');

        $e = new \Doctrine\ORM\Mapping\Driver\SimplifiedXmlDriver(array('C:\\Program Files\\EasyPHP-12.1\\www\\ProjetWebSujet2-master\\src\\FOS\\UserBundle\\Resources\\config\\doctrine' => 'FOS\\UserBundle\\Entity'));
        $e->setGlobalBasename('mapping');

        $f = new \Doctrine\ORM\Mapping\Driver\DriverChain();
        $f->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => 'C:\\Program Files\\EasyPHP-12.1\\www\\ProjetWebSujet2-master\\src\\Sujet2\\DevSpeBundle\\Entity')), 'Sujet2\\DevSpeBundle\\Entity');
        ...
        $g->setProxyDir('C:/Program Files/EasyPHP-12.1/www/ProjetWebSujet2-master/app/cache/dev/doctrine/orm/Proxies');
    ...
    {
        return $this->services['monolog.handler.main'] = new \Monolog\Handler\StreamHandler('C:/Program Files/EasyPHP-12.1/www/ProjetWebSujet2-master/app/logs/dev.log', 100, true);
    }
    ...
    protected function getProfilerService()
    {
        ...
        $this->services['profiler'] = $instance = new \Symfony\Component\HttpKernel\Profiler\Profiler(new \Symfony\Component\HttpKernel\Profiler\FileProfilerStorage('file:C:/Program Files/EasyPHP-12.1/www/ProjetWebSujet2-master/app/cache/dev/profiler', '', '', 86400), $a);
    ...
    {
        return $this->services['router'] = new \Symfony\Bundle\FrameworkBundle\Routing\Router($this, 'C:/Program Files/EasyPHP-12.1/www/ProjetWebSujet2-master/app/cache/dev/assetic/routing.yml', array('cache_dir' => 'C:/Program Files/EasyPHP-12.1/www/ProjetWebSujet2-master/app/cache/dev', 'debug' => true, 'generator_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_base_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_dumper_class' => 'Symfony\\Component\\Routing\\Generator\\Dumper\\PhpGeneratorDumper', 'generator_cache_class' => 'appDevUrlGenerator', 'matcher_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_base_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_dumper_class' => 'Symfony\\Component\\Routing\\Matcher\\Dumper\\PhpMatcherDumper', 'matcher_cache_class' => 'appDevUrlMatcher', 'strict_requirements' => true), $this->get('router.request_context', ContainerInterface::NULL_ON_INVALID_REFERENCE), $this->get('monolog.logger.router', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('C:/Program Files/EasyPHP-12.1/www/ProjetWebSujet2-master/app/cache/dev/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['sensio_distribution.webconfigurator'] = new \Sensio\Bundle\DistributionBundle\Configurator\Configurator('C:/Program Files/EasyPHP-12.1/www/ProjetWebSujet2-master/app');
    }
    ...
    {
        return $this->services['session.handler'] = new \Symfony\Component\HttpFoundation\Session\Storage\Handler\NativeFileSessionHandler('C:/Program Files/EasyPHP-12.1/www/ProjetWebSujet2-master/app/cache/dev/sessions');
    }
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('C:/Program Files/EasyPHP-12.1/www/ProjetWebSujet2-master/app/cache/dev/sessions');
    }
    ...
    {
        return $this->services['translator.default'] = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, $this->get('translator.selector'), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini')), array('cache_dir' => 'C:/Program Files/EasyPHP-12.1/www/ProjetWebSujet2-master/app/cache/dev/translations', 'debug' => true));
    }
    ...
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'exception_controller' => 'twig.controller.exception:showAction', 'autoescape_service' => NULL, 'autoescape_service_method' => NULL, 'cache' => 'C:/Program Files/EasyPHP-12.1/www/ProjetWebSujet2-master/app/cache/dev/twig', 'charset' => 'UTF-8', 'paths' => array()));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('C:\\Program Files\\EasyPHP-12.1\\www\\ProjetWebSujet2-master\\vendor\\symfony\\swiftmailer-bundle\\Symfony\\Bundle\\SwiftmailerBundle/Resources/views', 'Swiftmailer');
        $instance->addPath('C:\\Program Files\\EasyPHP-12.1\\www\\ProjetWebSujet2-master\\vendor\\doctrine\\doctrine-bundle\\Doctrine\\Bundle\\DoctrineBundle/Resources/views', 'Doctrine');
        $instance->addPath('C:\\Program Files\\EasyPHP-12.1\\www\\ProjetWebSujet2-master\\src\\Sujet2\\DevSpeBundle/Resources/views', 'Sujet2DevSpe');
        $instance->addPath('C:\\Program Files\\EasyPHP-12.1\\www\\ProjetWebSujet2-master\\src\\Acme\\SecurityBundle/Resources/views', 'AcmeSecurity');
        $instance->addPath('C:\\Program Files\\EasyPHP-12.1\\www\\ProjetWebSujet2-master\\src\\FOS\\UserBundle/Resources/views', 'FOSUser');
        $instance->addPath('C:\\Program Files\\EasyPHP-12.1\\www\\ProjetWebSujet2-master\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\WebProfilerBundle/Resources/views', 'WebProfiler');
        $instance->addPath('C:\\Program Files\\EasyPHP-12.1\\www\\ProjetWebSujet2-master\\vendor\\sensio\\distribution-bundle\\Sensio\\Bundle\\DistributionBundle/Resources/views', 'SensioDistribution');
    ...
    {
        $this->services['assetic.asset_factory'] = $instance = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), 'C:/Program Files/EasyPHP-12.1/www/ProjetWebSujet2-master/app/../web', true);
    ...
    {
        return $this->services['assetic.cache'] = new \Assetic\Cache\FilesystemCache('C:/Program Files/EasyPHP-12.1/www/ProjetWebSujet2-master/app/cache/dev/assetic/assets');
    }
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), 'C:/Program Files/EasyPHP-12.1/www/ProjetWebSujet2-master/app/cache/dev');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.debug' => true,
            'kernel.name' => 'app',
            'kernel.cache_dir' => 'C:/Program Files/EasyPHP-12.1/www/ProjetWebSujet2-master/app/cache/dev',
            ...
            'debug.container.dump' => 'C:/Program Files/EasyPHP-12.1/www/ProjetWebSujet2-master/app/cache/dev/appDevDebugProjectContainer.xml',
            ...
            'session.save_path' => 'C:/Program Files/EasyPHP-12.1/www/ProjetWebSujet2-master/app/cache/dev/sessions',
            ...
            'profiler.storage.dsn' => 'file:C:/Program Files/EasyPHP-12.1/www/ProjetWebSujet2-master/app/cache/dev/profiler',
            ...
            'router.resource' => 'C:/Program Files/EasyPHP-12.1/www/ProjetWebSujet2-master/app/cache/dev/assetic/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => 'C:/Program Files/EasyPHP-12.1/www/ProjetWebSujet2-master/app/cache/dev/twig',
                'charset' => 'UTF-8',
                'paths' => array(
            ...
            'swiftmailer.spool.default.memory.path' => 'C:/Program Files/EasyPHP-12.1/www/ProjetWebSujet2-master/app/cache/dev/swiftmailer/spool/default',
            ...
            'assetic.cache_dir' => 'C:/Program Files/EasyPHP-12.1/www/ProjetWebSujet2-master/app/cache/dev/assetic',
            ...
            'doctrine.orm.proxy_dir' => 'C:/Program Files/EasyPHP-12.1/www/ProjetWebSujet2-master/app/cache/dev/doctrine/orm/Proxies',
